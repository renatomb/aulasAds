...
class ClienteList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        parent::setDatabase('adianti');            // defines the database
        ...
        $this->form->addAction(_t('New'),  new TAction(array('ClienteForm', 'onEdit')), 'bs:plus-sign green');
        ...
        $column_dtnasce = new TDataGridColumn('datanascimento', 'Dt Nascimento', 'left');
        ...
        $this->datagrid->addColumn($column_dtnasce);
